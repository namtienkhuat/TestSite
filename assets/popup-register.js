...
const popupCloseIconRegister = document.querySelector(".popup__register-close");
const submitButtonRegister = document.querySelector(".register__button--submit");
const declineButtonRegister = document.querySelector(".register__button--decline");
